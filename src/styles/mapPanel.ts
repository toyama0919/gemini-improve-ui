/** Class added to body while turn map panel is visible */
export const MAP_BODY_CLASS = 'gemini-improve-ui-map-visible';

export function getMapPanelCss(contentReservePx: number): string {
  return `
    #gemini-map-panel {
      position: fixed;
      right: 16px;
    ...
    body.${MAP_BODY_CLASS} bard-sidenav-content {
      padding-right: ${contentReservePx}px !important;
