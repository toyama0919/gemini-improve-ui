...
`),a=t[i].querySelector("message-content .markdown"),s=a?St(a).trim():void 0,l=s?Ct(s):"";(r||l)&&n.push({user:r||"",model:l||""})}return n}function se(){return location.pathname.split("/").pop()||"unknown"}function j(e){return'"'+e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function Te(e,t){return e.split(`
`).map(n=>n===""?"":t+n).join(`
...
`+(d.prompt||"これについて詳しく"),r=!0}Oe(i,r)}function Qt(){const e="gemini-deep-dive-styles";if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=`
