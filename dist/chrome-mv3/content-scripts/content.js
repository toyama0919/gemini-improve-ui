...
`).trim()}async function bt(){const e=document.querySelector("infinite-scroller.chat-history");if(!e)return;B("メッセージを読み込み中...");let t=0;for(let n=0;n<30;n++){e.scrollTop=0,await new Promise(o=>setTimeout(o,400));const i=document.querySelectorAll("user-query").length;if(i===t)break;t=i}e.scrollTop=e.scrollHeight}function yt(){const e=Array.from(document.querySelectorAll("user-query")),t=Array.from(document.querySelectorAll("model-response")),n=[],i=Math.min(e.length,t.length);for(let o=0;o<i;o++){const r=Array.from(e[o].querySelectorAll(".query-text-line")).map(c=>c.innerText.trim()).filter(Boolean).join(`
`),a=t[o].querySelector("message-content .markdown"),s=a?ht(a).trim():void 0,l=s?gt(s):"";(r||l)&&n.push({user:r||"",model:l||""})}return n}function ne(){return location.pathname.split("/").pop()||"unknown"}function z(e){return'"'+e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function Se(e,t){return e.split(`
`).map(n=>n===""?"":t+n).join(`
...
`).map(u=>u.trim()).filter(Boolean),l=s.find(u=>!/^https?:\/\//i.test(u))||s[0]||"Gemini chat",c=(a||l).slice(0,60),d=ne(),p=[`id: ${z(d)}`,`title: ${z("Gemini: "+c)}`,`date: ${z(o)}`,`source: ${z(location.href)}`,"tags:","  - gemini","  - fleeting","chats:"];for(const u of e)p.push("  - q: |"),p.push(Se(u.user,"      ")),p.push("    a: |"),p.push(Se(u.model,"      "));return{markdown:p.join(`
`),id:r,title:c}}async function Ae(e=!1){await bt();const t=yt();if(t.length===0){B("保存できる会話が見つかりません","error");return}let n;try{if(e){const l=await window.showDirectoryPicker({mode:"readwrite"});await Ee(l),y=l,n=l,B(`保存先を変更: ${l.name}`)}else n=await mt()}catch{return}const{markdown:i,title:o}=xt(t),r=ne(),s=`gemini-${o.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g,"-").slice(0,40)}-${r}.yaml`;try{const d=await(await(await n.getDirectoryHandle("inbox",{create:!0})).getFileHandle(s,{create:!0})).createWritable();await d.write(i),await d.close(),B(`保存しました: inbox/${s}`)}catch{B("保存に失敗しました","error")}}function B(e,t="success"){const n=document.getElementById("gemini-export-notification");n&&n.remove();const i=document.createElement("div");i.id="gemini-export-notification",i.style.cssText=`
    position: fixed;
    bottom: 24px;
    right: 24px;
...
Shift+クリックで保存先を変更`,t.textContent="💾 Save note",t.style.cssText=`
  ...
  `,t.addEventListener("mouseenter",()=>{t.style.background="#1557b0"}),t.addEventListener("mouseleave",()=>{t.style.background="#1a73e8"}),t.addEventListener("click",n=>Ae(n.shiftKey)),document.body.appendChild(t)}function Ce(){ne()!=="app"&&wt()}let oe=-1;function vt(e){oe=e}function Et(e){if($()&&(e.key==="ArrowUp"||e.key==="ArrowDown"||e.key==="Enter"||e.key==="Tab"||e.key==="Escape"))return!1;if(h(e,"chat.navigateToSearch"))return e.preventDefault(),xe(),!0;if(h(e,"search.moveUp"))return e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),st(),!0;if(h(e,"search.moveDown"))return e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),lt(),!0;if(h(e,"search.openResult"))return e.isComposing?!1:(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),ct(),!0);if(h(e,"search.scrollUp"))return e.preventDefault(),window.scrollBy({top:-window.innerHeight*.8,behavior:"auto"}),!0;if(h(e,"search.scrollDown"))return e.preventDefault(),window.scrollBy({top:window.innerHeight*.8,behavior:"auto"}),!0;const t=le();return!!Object.values(t.chat).includes(e.code)}function St(e){const t=e.target.matches('input, textarea, [contenteditable="true"]');if($()&&(e.key==="ArrowUp"||e.key==="ArrowDown"||e.key==="Enter"||e.key==="Tab"||e.key==="Escape"))return!1;if(e.code==="Home"&&!e.metaKey&&!e.ctrlKey&&!t)return e.preventDefault(),Ae(e.shiftKey),!0;if(e.ctrlKey&&e.shiftKey&&e.code==="KeyD")return e.preventDefault(),window.domAnalyzer?.copyToClipboard(),!0;if(h(e,"chat.navigateToSearch"))return e.preventDefault(),xe(),!0;if(h(e,"chat.toggleSidebar"))return e.preventDefault(),nt(),!0;if(h(e,"chat.toggleHistoryMode")){e.preventDefault();const n=X(),i=n.length>0;if(M())_(),be();else if(t)if(i){let o=oe;(o<0||o>=n.length)&&(o=n.length-1),n[o].focus()}else ye();else{const o=document.activeElement;if(o&&(o.classList?.contains("deep-dive-button-inline")||o.getAttribute("data-action")==="deep-dive")){const a=n.findIndex(s=>s===o);a!==-1&&(oe=a),ye()}else be()}return!0}if(M()&&h(e,"chat.historyExit"))return e.preventDefault(),_(),!0;if(h(e,"chat.scrollUp"))return e.preventDefault(),ge("up"),!0;if(h(e,"chat.scrollDown"))return e.preventDefault(),ge("down"),!0;if(M()){if(h(e,"chat.historyUp"))return e.preventDefault(),it(),!0;if(h(e,"chat.historyDown"))return e.preventDefault(),rt(),!0;if(h(e,"chat.historyOpen"))return e.preventDefault(),at(),!0}if(!M()&&t&&(h(e,"chat.historyUp")||h(e,"chat.historyDown"))){const n=document.querySelector('div[contenteditable="true"][role="textbox"]');if(n&&n.textContent?.trim()===""){e.preventDefault();const i=h(e,"chat.historyUp")?"up":"down";return Ze(i),!0}}if(!M()&&!t){const n=document.activeElement;if(n&&(n.classList?.contains("deep-dive-button-inline")||n.getAttribute("data-action")==="deep-dive")){if(h(e,"chat.historyUp")||h(e,"chat.historyDown")){e.preventDefault();const o=h(e,"chat.historyUp")?"up":"down";return et(o),!0}if(e.key==="ArrowRight"||e.key==="ArrowLeft"){e.preventDefault();const o=n._expandButton,r=n._deepDiveTarget;if(o&&r){const a=o.getAttribute("data-action")==="collapse";(e.key==="ArrowRight"&&!a||e.key==="ArrowLeft"&&a)&&o.click()}return!0}if(h(e,"chat.historyOpen"))return e.preventDefault(),n.click(),!0}}return!1}function At(){je().then(()=>{document.addEventListener("keydown",e=>{if(P()){Et(e);return}St(e)},!0)})}const K=[{id:"default",prompt:"これについて詳しく"}];function Te(){const e=document.querySelectorAll(".markdown-main-panel");e.length!==0&&e.forEach(t=>{const n=[],i=t.querySelectorAll("h1[data-path-to-node], h2[data-path-to-node], h3[data-path-to-node], h4[data-path-to-node], h5[data-path-to-node], h6[data-path-to-node]");i.length>0?(i.forEach(s=>{const l=s.querySelector(".deep-dive-button-inline");if(l){if(l.hasAttribute("data-initialized"))return;s.querySelectorAll(".deep-dive-button-inline, .deep-dive-expand-button").forEach(c=>c.remove())}n.push({type:"section",element:s,getContent:()=>Tt(s)})}),t.querySelectorAll("table[data-path-to-node]").forEach(s=>{const l=s.closest(".table-block-component");if(l){const c=l.querySelector(".deep-dive-button-inline");if(c){if(c.hasAttribute("data-initialized"))return;c.remove()}n.push({type:"table",element:l,getContent:()=>De(s)})}}),Ct(t,i).forEach(s=>{const l=s.anchor.querySelector(".deep-dive-button-inline");if(l){if(l.hasAttribute("data-initialized"))return;l.remove()}n.push({type:"orphan",element:s.anchor,getContent:()=>s.elements.map(c=>c.textContent?.trim()??"").filter(Boolean).join(`

`)})})):(t.querySelectorAll("table[data-path-to-node]").forEach(l=>{const c=l.closest(".table-block-component");if(c){const d=c.querySelector(".deep-dive-button-inline");if(d){if(d.hasAttribute("data-initialized"))return;d.remove()}n.push({type:"table",element:c,getContent:()=>De(l)})}}),t.querySelectorAll("blockquote[data-path-to-node]").forEach(l=>{const c=l.querySelector(".deep-dive-button-inline");if(c){if(c.hasAttribute("data-initialized"))return;c.remove()}n.push({type:"blockquote",element:l,getContent:()=>l.textContent?.trim()??""})}),t.querySelectorAll("ol[data-path-to-node], ul[data-path-to-node]").forEach(l=>{const c=l.querySelector(":scope > .deep-dive-button-inline");if(c){if(c.hasAttribute("data-initialized"))return;l.querySelectorAll(".deep-dive-button-inline, .deep-dive-expand-button").forEach(u=>u.remove())}let d=l.parentElement,p=!1;for(;d&&d!==t;){if((d.tagName==="OL"||d.tagName==="UL")&&d.hasAttribute("data-path-to-node")){p=!0;break}d=d.parentElement}p||n.push({type:"list",element:l,getContent:()=>Dt(l)})})),n.forEach(r=>kt(r))})}function Ct(e,t){const n=new Set(Array.from(t)),i=Array.from(e.children),o=[];let r=[],a=!1;const s=l=>{r.length>0&&!l&&o.push({anchor:r[0],elements:[...r]}),r=[]};for(const l of i){const c=l.tagName,d=c==="P";n.has(l)||c==="H1"||c==="H2"||c==="H3"||c==="H4"||c==="H5"||c==="H6"?(s(a),a=!0):c==="HR"?(s(a),a=!1):d?r.push(l):(s(a),a=!1)}return s(a),o}function Tt(e){let t=(e.textContent?.trim()??"")+`
...
`;else{const a=await new Promise(u=>{chrome.storage.sync.get(["deepDiveModes","currentDeepDiveModeId"],u)}),s=a.deepDiveModes&&a.deepDiveModes.length>0?a.deepDiveModes:K;let d=new URLSearchParams(location.search).get("mode_id")||a.currentDeepDiveModeId||s[0]?.id;s.some(u=>u.id===d)||(d=s[0]?.id);const p=s.find(u=>u.id===d)||s[0]||K[0];o=i+`
...
`)}),n}async copyToClipboard(){const t=this.exportForAI();try{return await navigator.clipboard.writeText(t),this.showNotification("ページ構造をクリップボードにコピーしました"),!0}catch{return this.showNotification("コピーに失敗しました","error"),!1}}showNotification(t,n="success"){const i=document.createElement("div");i.style.cssText=`
    ...
    `,document.head.appendChild(o),document.body.appendChild(i),setTimeout(()=>{i.style.transition="opacity 0.3s",i.style.opacity="0",setTimeout(()=>i.remove(),300)},3e3)}}function Kt(){window.domAnalyzer=new zt,window.analyzePage=()=>{console.log(window.domAnalyzer.capturePageStructure())},window.copyPageStructure=()=>{window.domAnalyzer.copyToClipboard()}}const jt={matches:["https://gemini.google.com/app*","https://gemini.google.com/search*"],runAt:"document_end",main(){window.rememberActionButtonPosition=vt,Kt(),Ft()}};function Ue(){const e="gemini-improve-ui-custom-styles";document.getElementById(e)?.remove();const t=document.createElement("style");t.id=e,t.textContent=`
    .gems-list-container {
  ...
  `,document.head.appendChild(t)}function Oe(e){document.documentElement.style.setProperty("--chat-max-width",`${e}px`)}function Wt(){chrome.storage.sync.get(["chatWidth"],e=>{Oe(e.chatWidth||900)})}function Ft(){Wt(),Ue(),window.addEventListener("popstate",()=>{_()});let e=location.href;new MutationObserver(()=>{const t=location.href;t!==e&&(e=t,window.rememberActionButtonPosition?.(-1),_t(),setTimeout(()=>{Q(),fe(),P()||$e(),document.getElementById("gemini-export-note-button")?.remove(),Ce()},1500))}).observe(document,{subtree:!0,childList:!0}),At(),P()?(dt(),fe()):(ot(),Lt(),setTimeout(()=>{Ce()},1500),setTimeout(()=>{$e()},1500)),chrome.storage.onChanged.addListener((t,n)=>{n==="sync"&&t.chatWidth&&(Oe(t.chatWidth.newValue),Ue())})}function W(e,...t){}const Gt={debug:(...e)=>W(console.debug,...e),log:(...e)=>W(console.log,...e),warn:(...e)=>W(console.warn,...e),error:(...e)=>W(console.error,...e)},_e=globalThis.browser?.runtime?.id?globalThis.browser:globalThis.chrome;var ze=class Ke extends Event{static EVENT_NAME=ae("wxt:locationchange");constructor(t,n){super(Ke.EVENT_NAME,{}),this.newUrl=t,this.oldUrl=n}};function ae(e){return`${_e?.runtime?.id}:content:${e}`}const Vt=typeof globalThis.navigation?.addEventListener=="function";function Yt(e){let t,n=!1;return{run(){n||(n=!0,t=new URL(location.href),Vt?globalThis.navigation.addEventListener("navigate",i=>{const o=new URL(i.destination.url);o.href!==t.href&&(window.dispatchEvent(new ze(o,t)),t=o)},{signal:e.signal}):e.setInterval(()=>{const i=new URL(location.href);i.href!==t.href&&(window.dispatchEvent(new ze(i,t)),t=i)},1e3))}}}var Qt=class H{static SCRIPT_STARTED_MESSAGE_TYPE=ae("wxt:content-script-started");id;abortController;locationWatcher=Yt(this);constructor(t,n){this.contentScriptName=t,this.options=n,this.id=Math.random().toString(36).slice(2),this.abortController=new AbortController,this.stopOldScripts(),this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(t){return this.abortController.abort(t)}get isInvalid(){return _e.runtime?.id==null&&this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(t){return this.signal.addEventListener("abort",t),()=>this.signal.removeEventListener("abort",t)}block(){return new Promise(()=>{})}setInterval(t,n){const i=setInterval(()=>{this.isValid&&t()},n);return this.onInvalidated(()=>clearInterval(i)),i}setTimeout(t,n){const i=setTimeout(()=>{this.isValid&&t()},n);return this.onInvalidated(()=>clearTimeout(i)),i}requestAnimationFrame(t){const n=requestAnimationFrame((...i)=>{this.isValid&&t(...i)});return this.onInvalidated(()=>cancelAnimationFrame(n)),n}requestIdleCallback(t,n){const i=requestIdleCallback((...o)=>{this.signal.aborted||t(...o)},n);return this.onInvalidated(()=>cancelIdleCallback(i)),i}addEventListener(t,n,i,o){n==="wxt:locationchange"&&this.isValid&&this.locationWatcher.run(),t.addEventListener?.(n.startsWith("wxt:")?ae(n):n,i,{...o,signal:this.signal})}notifyInvalidated(){this.abort("Content script context invalidated"),Gt.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){document.dispatchEvent(new CustomEvent(H.SCRIPT_STARTED_MESSAGE_TYPE,{detail:{contentScriptName:this.contentScriptName,messageId:this.id}})),window.postMessage({type:H.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:this.id},"*")}verifyScriptStartedEvent(t){const n=t.detail?.contentScriptName===this.contentScriptName,i=t.detail?.messageId===this.id;return n&&!i}listenForNewerScripts(){const t=n=>{!(n instanceof CustomEvent)||!this.verifyScriptStartedEvent(n)||this.notifyInvalidated()};document.addEventListener(H.SCRIPT_STARTED_MESSAGE_TYPE,t),this.onInvalidated(()=>document.removeEventListener(H.SCRIPT_STARTED_MESSAGE_TYPE,t))}};function en(){}function F(e,...t){}const Xt={debug:(...e)=>F(console.debug,...e),log:(...e)=>F(console.log,...e),warn:(...e)=>F(console.warn,...e),error:(...e)=>F(console.error,...e)};return(async()=>{try{const{main:e,...t}=jt;return await e(new Qt("content",t))}catch(e){throw Xt.error('The content script "content" crashed on startup!',e),e}})()})();
content;